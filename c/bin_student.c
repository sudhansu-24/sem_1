...
int main() {
    FILE *studentFile = fopen("Student.dat", "wb");
    ...
    struct Student student1 = {"Tanishque", 15, 95.5};
    struct Student student2 = {"VISHAL", 75, 92.0};
    ...
    struct Student newStudentData = {"SHRAY DOBHAL", 75, 95.0};  // Updated name and roll number
